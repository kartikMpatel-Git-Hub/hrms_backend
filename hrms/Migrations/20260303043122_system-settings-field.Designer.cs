...
namespace hrms.Migrations
{
    ...
    [Migration("20260303043122_system-settings-field")]
    partial class systemsettingsfield
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hrms.Model.Post", b =>
                {
                    ...
                    b.Property<string>("InAppropriateReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
            ...
            modelBuilder.Entity("hrms.Model.SystemSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AnniversaryImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("anniversary_image_url");

                    b.Property<string>("BirthdayImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
                        .HasColumnName("birthday_image_url");

                    b.Property<int?>("DefaultHrId")
                        .HasColumnType("int");

                    b.Property<string>("DefaultProfileImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)")
            ...
            modelBuilder.Entity("hrms.Model.SystemSettings", b =>
                {
                    b.HasOne("hrms.Model.User", "DefaultHr")
                        .WithMany()
                        .HasForeignKey("DefaultHrId")
                        .OnDelete(DeleteBehavior.Restrict)
